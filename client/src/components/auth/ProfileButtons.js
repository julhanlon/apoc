  ...
  return (
    <nav className="auth-options" style={{ marginTop: "10px" }}>
      {userData.user ? (
        <>     <Button classes={{
        ...
        }} style={{ float: 'right', marginRight: "20px" }} variant="contained" size="small" onClick={logout}>
          Log Out
    </Button>
          ...
          <Button classes={{
            root: classes.root, // class name, e.g. `classes-nesting-root-x`
            label: classes.label, // class name, e.g. `classes-nesting-label-x`
          }} style={{ float: 'right', marginRight: "20px" }} variant="contained" size="small" onClick={main}>
            Dashboard
     </Button>
